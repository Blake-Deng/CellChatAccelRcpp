...
This directory contains the primary v0.1.5 `sparse_stream` benchmark track and one supporting validation track. The GitHub and manuscript narrative starts from the `sparse_stream` benchmark.

## Benchmark Tracks

| directory | role | status | main result |
| --- | --- | --- | --- |
| [`cellchat_acceleration_2026`](cellchat_acceleration_2026) | Main v0.1.5 `sparse_stream` benchmark for the Bioinformatics Application Note | Complete | 12 real datasets, 216 paired original/accelerated comparisons, 648 ablation runs, median 17.5x speedup |
